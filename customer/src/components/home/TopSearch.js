            ...
            <Col md={8}>
              <div className='homepage-search-title'>
                <h1 className='mb-2 font-weight-normal'>
                  <span className='font-weight-bold'>Find Awesome Food!</span> in Singapore
                </h1>
                <h5 className='mb-5 text-secondary font-weight-normal'>
                  Lists of top restaurants, cafes, pubs, and bars based on trends
                </h5>
              </div>
                ...
                <Form className='form-noborder'>
                  <div className='form-row'>
                    ...
                    <Form.Group className='col-lg-2 col-md-2 col-sm-12'>
                      <Link to='restaurants' className='btn btn-primary btn-block btn-lg btn-gradient'>
                        Search
                      </Link>
                    </Form.Group>
                  </div>
