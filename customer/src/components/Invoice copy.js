              ...
              <Col md={8} className="mx-auto">
                <div className="p-5 osahan-invoice bg-white shadow-sm">
                  <Row className="mb-5 pb-3">
                    <Col md={8} xs={10}>
                      <h3 className="mt-0">
                        Thanks for choosing <strong className="text-secondary">Osahan Eat</strong>, Gurdeep ! Here are
                        your order details:{' '}
                      </h3>
                    </Col>
                    <Col md={4} xs={2} className="pl-0 text-right">
                      <p className="mb-4 mt-2">
                        <Link className="text-primary font-weight-bold" to="#">
                          <Icofont icon="clock-print" /> PRINT
                        </Link>
                      </p>
                  ...
                  <Row>
                    <Col md={6}>
                      <HeadingValue heading="Order No:" value="#25102589748" className="text-black" />
                      <HeadingValue heading="Order placed at:" value="12/11/2018, 06:26 PM" />
                      <HeadingValue heading="Order delivered at:" value="12/11/2018, 07:18 PM" />
                    ...
                    <Col md={6}>
                      ...
                      <HeadingValue className="text-primary" value="Gurdeep Singh Osahan" />
                      <HeadingValue
                  ...
                  <Row className="mt-5">
                    <Col md={12}>
                      ...
                      <h6 className="mb-1 text-black">
                        <strong>Shahi Khansama</strong>
                      </h6>
                      <HeadingValue heading="Shop 3, Model Town Extension, Model Town, Ludhiana" />
