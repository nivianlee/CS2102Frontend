                ...
                <div className="osahan-account-page-left shadow-sm bg-white h-100">
                    ...
                    <div className="osahan-user text-center">
                      <div className="osahan-user-media">
                        ...
                        <div className="osahan-user-media-body">
                          <h6 className="mb-2">{localStorage.getItem('loggedInUserName')}</h6>
                          <p className="mb-1">{localStorage.getItem('loggedInUserPhone')}</p>
                          <p>{localStorage.getItem('loggedInUserEmail')}</p>
                  ...
                  <ul className="nav flex-column border-0 pt-4 pl-4 pb-4">
                    <li className="nav-item">
                      <NavLink className="nav-link" activeClassName="active" exact to="/myaccount/orders">
                    ...
                    <li className="nav-item">
                      <NavLink className="nav-link" activeClassName="active" exact to="/myaccount/addresses">
