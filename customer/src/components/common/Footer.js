            ...
            <Row>
              <Col xs={12}>
                ...
                <div className='search-links'>
                  <Link to='#'>Indonesia</Link> |<Link to='#'>Singapore</Link> |<Link to='#'>Thailand</Link> |
                </div>
                <p className={this.props.popularFHclassName}>POPULAR FOOD</p>
                <div className='search-links'>
                  <Link to='#'>Fast Food</Link> |<Link to='#'>Chinese</Link> |<Link to='#'>Japanese</Link> |
                  <Link to='#'>Indian</Link> |<Link to='#'>Vietnamese</Link> |<Link to='#'>Western</Link> |
                  <Link to='#'>Thai</Link> |<Link to='#'>Korean</Link> |<Link to='#'>Halal</Link> |
                </div>
              </Col>
            </Row>
          </div>
        ...
        <footer className='pt-4 pb-4 text-center'>
          <Container>
            ...
            <small className='mt-0 mb-0'>
              {' '}
              Made with <FontAwesome icon={this.props.madewithIconclassName} /> by
              <Link className='text-danger ml-1' target='_blank' to={`${this.props.firstLink}`}>
                {this.props.firstLinkText}
              </Link>{' '}
              -{' '}
              <Link className='text-primary' target='_blank' to={this.props.secondLink}>
