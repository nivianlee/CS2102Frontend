...
import ResFoodItems from './components/ResFoodItemsNoCart';
import LandingPage from './components/LandingPage';
import GoLogin from './components/common/GoLogin';
import ResFoodItemsNoCart from './components/ResFoodItemsNoCart';
      ...
      return (
        <>
          ...
          <Switch>
            ...
            <Route path='/thanks' exact component={Thanks} />
            <Route path='/restaurants' exact component={Restaurants} />
            <Route path='/restaurants/foods/:resID' exact component={ResFoodItemsNoCart} />
            <Route exact component={GoLogin} />
          </Switch>
          {this.props.location.pathname !== '/login' && this.props.location.pathname !== '/register' ? <Footer /> : ''}
        </>
      );
